...
const PostbyID = (props) => {
    ...
    return (
        <Fragment>
            <div>
                <Link to='/posts' ><button className="btn" id="postButton">Back</button></Link>
                <table id="postsTable">
                    <tbody>
                        <tr>
                            <th>Name</th>
                ...
                {props.token === props.match.params.id?<button type="button" id="deleteButton" className="btn btn-danger" onClick={deletePostHandler}>Delete Post</button>:<Fragment></Fragment>}
            </div>
        </Fragment>
    )
}
