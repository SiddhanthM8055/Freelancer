    ...
    return (
      ...
      <form className="form" onSubmit={onSubmitHandler}>
        ...
        <div class="form-group">
          ...
          />
          <small class="form-text">Impress the employers with your Github repo</small>
        </div>
        <div className="form-group">
          <textarea placeholder="A short bio of yourself" id="splTextArea" name="bio" value={bio} onChange = {onChangeHandler}></textarea>
